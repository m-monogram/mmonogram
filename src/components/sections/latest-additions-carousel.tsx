  ...
  ({ onProjectClick, className }: LatestAdditionsCarouselProps) => {
    ...
    return (
      <section className={cn("relative z-10 section-flow-light", className)}>
        <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-10 pt-32 pb-32 sm:pt-44 sm:pb-44 md:pt-56 md:pb-56 lg:pt-64 lg:pb-64">
          <motion.h2
            initial={{ opacity: 0, y: 12 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
            className="font-display font-bold uppercase tracking-[0.18em] text-lg sm:text-2xl md:text-3xl text-black text-center mb-10 sm:mb-14"
          >
