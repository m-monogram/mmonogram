      ...
      <div className="relative z-10">
          ...
          <ScrollReveal delay={0.05} className="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-8">
                ...
                {quickLinks.map((link) => (
                  <li key={link.labelKey}>
                    ...
                    <a
                      ...
                      className="tap-target text-white/60 hover:text-white transition-colors font-body text-caption cursor-pointer"
                    >
                      {t(link.labelKey)}
                    </a>
                  </li>
            ...
            <div>
              ...
              <div className="space-y-2">
                <a
                  ...
                  className="tap-target flex items-center gap-2 text-white/60 hover:text-white transition-colors font-body text-caption"
                >
            ...
            <div>
              ...
              <a
                ...
                className="tap-target flex items-start gap-2 text-white/60 hover:text-white transition-colors font-body text-caption mb-1"
              >
              ...
              <div className="flex gap-2">
                {socialLinks.map((social, index) => (
                  <a
                    ...
                    className="w-11 h-11 border border-white/20 flex items-center justify-center text-white/50 hover:text-white hover:border-white/50 hover:bg-white/5 transition-all"
                  >
        ...
        <div>
          <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-12 py-3">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-2 text-white/40 font-meta text-[10px] sm:text-[11px] uppercase tracking-[0.22em]">
              <p className="font-meta text-[inherit] leading-none">
                © {new Date().getFullYear()} M-MONOGRAM. {t("footer.rights")}.
              </p>
              <div className="flex gap-4">
                <Link to="/privacy-policy" className="tap-target font-meta hover:text-white/65 transition-colors">
                  {t("footer.privacy")}
                </Link>
                <Link to="/offer-agreement" className="tap-target font-meta hover:text-white/65 transition-colors">
                  {t("footer.terms")}
                </Link>
              </div>
            </div>
